...
export default function ShiftShareAnalysis() {
  ...
  const data =
    period === "2021-2025" ? shiftShare2021_2025 : shiftShare2016_2020;
    ...
    <section className="relative">
      <div className="max-w-6xl mx-auto px-6 pt-24 pb-8">
        ...
        <p className="body-lg mt-3 max-w-2xl">
          Dekomposisi perubahan output regional menjadi tiga komponen: Regional
          Share (pertumbuhan nasional), Proportionality Shift (bauran industri),
          dan Differential Shift (keunggulan kompetitif).
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          ...
          >
            ...
            <p className="text-xs text-zinc-500 mt-2">
              ...
              daerah tumbuh lebih cepat dari sektor yang sama di tingkat
              nasional.
            </p>
          </div>
        </div>
