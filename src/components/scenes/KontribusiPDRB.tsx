...
import {
  sektorPrimer, sektorSekunder, sektorTersier, years,
  kontribusiAdhkData,
...
export default function KontribusiPDRB() {
  ...
  const DETAIL_COLORS = [
    "#d97706", "#92400e", "#7c3aed", "#4338ca", "#10b981",
    "#047857", "#3b82f6", "#1d4ed8", "#ef4444", "#dc2626",
    ...
    <section className="relative">
      <div className="max-w-6xl mx-auto px-6 pt-24 pb-8">
        ...
        <p className="body-lg mt-3 max-w-2xl">
          ...
          terhadap PDRB ADHK 2010. Perhatikan transformasi dari sektor
          sekunder ke tersier.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        {view === "grouped" && (
          ...
          >
            <ResponsiveContainer width="100%" height={400}>
              <AreaChart data={groupedData} margin={{ top: 10, right: 30, bottom: 0, left: 0 }}>
                ...
                <Area type="monotone" dataKey="Primer" stackId="1" stroke="#10b981" fill="#10b981" fillOpacity={0.7} />
                <Area type="monotone" dataKey="Sekunder" stackId="1" stroke="#3b82f6" fill="#3b82f6" fillOpacity={0.7} />
                <Area type="monotone" dataKey="Tersier" stackId="1" stroke="#f59e0b" fill="#f59e0b" fillOpacity={0.7} />
              </AreaChart>
            </ResponsiveContainer>
          </motion.div>
        )}
        ...
        {view === "detail" && (
          ...
          >
            <ResponsiveContainer width="100%" height={400}>
              <AreaChart data={detailData} margin={{ top: 10, right: 30, bottom: 0, left: 0 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
                <XAxis dataKey="year" tick={{ fontSize: 11, fill: "#a1a1aa" }} />
                <YAxis tick={{ fontSize: 11, fill: "#a1a1aa" }} axisLine={false} tickLine={false} domain={[0, 100]} unit="%" />
                <Tooltip
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          <div className="stat-box">
            <div className="stat-value" style={{ color: "#3b82f6" }}>43.17%</div>
          ...
          <div className="stat-box">
            <div className="stat-value" style={{ color: "#f59e0b" }}>41.91%</div>
          ...
          <div className="stat-box">
            <div className="stat-value" style={{ color: "#10b981" }}>14.92%</div>
